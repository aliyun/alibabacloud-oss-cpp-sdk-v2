// Demonstrates: Create an agentic bucket.
...
int main(int argc, char* argv[]) {
    ...
    auto outcome = client.createAgenticBucket(
        oss::agentic::models::CreateAgenticBucketRequest()
            .setBucket(args.bucket)
            .setCreateAgenticBucketConfiguration(
                oss::agentic::models::CreateAgenticBucketConfiguration().setStorageClass("Standard")));
